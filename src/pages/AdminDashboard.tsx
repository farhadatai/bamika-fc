...
import { Shield, Users, X, Trash2 } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto p-4 space-y-6 font-sans">
      ...
      <div className="flex border-b border-gray-200 bg-white rounded-t-xl overflow-hidden shadow-sm">
        {['parents', 'roster', 'coaches', 'schedule', 'drills'].map((t) => (
          <button
            key={t}
            className={`px-6 py-4 font-black text-[10px] uppercase tracking-widest transition-all ${
              activeTab === t
        ...
        {activeTab === 'schedule' && (
          <div className="space-y-4">
            ...
            {data.games.map((g: any) => (
              ...
              >
                <div>
                  <div className="font-black uppercase italic text-gray-900">
                    {g.opponent}
                  </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
            ...
            <form onSubmit={handleAddGame} className="p-8 space-y-4">
              <input
                ...
                required
                value={newGame.date}
                className="w-full border p-4 rounded-xl font-bold focus:border-[#EF4444] outline-none"
                onChange={(e) =>
