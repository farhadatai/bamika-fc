...
const coachesData: Coach[] = [
  ...
  ...Array(3)
    ...
    .map((_, i) => ({
      ...
      image:
        'https://images.unsplash.com/photo-1519315901367-f34ff9154487?auto=format&fit=crop&q=80&w=400',
      ...
      >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-black border-t border-white/10 py-4 px-6 space-y-4 absolute w-full">
            <Link
              to="/"
              className="block text-lg font-medium text-white hover:text-[#EF4444]"
